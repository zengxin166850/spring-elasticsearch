...
!function(a) {
    ...
    ace.demo = {
        ...
        init:function(a) {
            var a = !!a && !0;
            if ("function" == typeof requirejs || a) for (var b in ace.demo.functions) ace.demo.functions.hasOwnProperty(b) && ace.demo.functions[b]();
        }
        ...
        a('.ace-nav [class*="icon-animated-"]').closest("a").one("click", function() {
            ...
            b.preventDefault(), a(window).triggerHandler("resize.navbar.dropdown"));
        });
        ...
        a(document).on("hide.bs.collapse show.bs.collapse", function(b) {
            ...
            0 == d.length && (d = a('a[data-target*="#' + c + '"]')), 0 != d.length && d.find(ace.vars[".icon"]).each(function() {
                ...
                f = "fa-" + c[1] + "-up"), e ? ("show" == b.type ? d.removeClass(e).addClass(f) :d.removeClass(f).addClass(e), 
                !1) :void 0;
            });
        });
...
}(jQuery), /*body的返回顶部按钮功能
function(a, b) {
    var c = a(".btn-scroll-up");
    if (c.length > 0) {
        var d = !1;
        a("#page-content").on("scroll.scroll_btn", function() {
            ...
            d = !0) :d && (c.removeClass("display"), d = !1);
    ...
    function c(b, c) {
        ...
        this.force_reload = !1, this.loadUrl = function(a, b, c) {
            var d = !1;
            a = a.replace(/^(\#\!)?\#/, ""), this.force_reload = b === !1, "function" == typeof this.settings.content_url && (d = this.settings.content_url(a)), 
            ...
            if (!j) {
                ...
                if (g.trigger(o = a.Event("ajaxloadstart"), {
                    ...
                    "POST" == i && "object" == typeof n && (p = a.extend({}, p, n)), a.ajax(p).error(function() {
                        ...
                        var o = null, p = "";
                        if ("function" == typeof h.settings.update_active) o = h.settings.update_active.call(null, c, b, i, m); else if (h.settings.update_active === !0 && c && (o = a('a[data-url="' + c + '"]'), 
                        o.length > 0)) {
                            var q = o.closest(".nav");
                            if (q.length > 0) {
                                q.find(".active").each(function() {
                                    var b = "active";
                                    (a(this).hasClass("hover") || h.settings.close_active) && (b += " open"), a(this).removeClass(b), 
                        ...
                        k.addClass("content-loaded").detach(), m && (j = String(j).replace(/<(title|link)([\s\>])/gi, '<div class="hidden ajax-append-$1"$2').replace(/<\/(title|link)\>/gi, "</div>"), 
                        g.empty().html(j)), a(h.settings.loading_overlay || g).append(k), m && setTimeout(function() {
                        ...
                        }, 10), "function" == typeof h.settings.update_title ? h.settings.update_title.call(null, c, b, p, i, m) :h.settings.update_title === !0 && "GET" == i && f(p), 
        ...
        this.startLoading = function() {
            j || (j = !0, this.settings.loading_overlay || "static" != g.css("position") || (g.css("position", "relative"), 
            l = !0), k.remove(), k = a('<div class="ajax-loading-overlay"><i class="ajax-loading-icon ' + (this.settings.loading_icon || "") + '"></i> ' + this.settings.loading_text + "</div>"), 
            ...
            a === !0 ? (j = !1, k.remove(), l && (g.css("position", ""), l = !1), null != m && (clearTimeout(m), 
            m = null)) :(k.addClass("almost-loaded"), g.one("ajaxscriptsloaded.inner_call", function() {
                h.stopLoading(!0);
            }));
            ...
            a.ajaxPrefilter("script", function(a) {
                ...
                function e() {
                    "function" == typeof c && c(), a('.btn-group[data-toggle="buttons"] > .btn').button(), 
                ...
                g.on(c, function(c) {
                    function h(a) {
                        if (k) {
                            ...
                            }, k && i && (m = 0, n = 0, l = Math.abs(n = k.coords[1] - i.coords[1]) > f && Math.abs(m = k.coords[0] - i.coords[0]) <= Math.abs(n) ? n > 0 ? "up" :"down" :Math.abs(m = k.coords[0] - i.coords[0]) > f && Math.abs(n) <= Math.abs(m) ? m > 0 ? "left" :"right" :!1, 
                            l !== !1)) {
                                var c = {
                                    cancel:!1
                                };
    ...
    function c(b, c) {
        function e() {
            this.mobile_view = this.mobile_style < 4 && this.is_mobile_view(), this.collapsible = !this.mobile_view && this.is_collapsible(), 
        ...
        this.settings = a.extend({}, a.fn.ace_sidebar.defaults, c, g), this.minimized = !1, 
        this.collapsible = !1, this.horizontal = !1, this.mobile_view = !1, this.vars = function() {
            return {
        ...
        this.toggleMenu = function(c, d) {
            ...
            return c || (c = i()), c && h.call(c, this.minimized, d), ace.vars.old_ie && ace.helper.redraw(b), 
            ...
            if (this.mobile_view && 3 == this.mobile_style) {
                ...
                this.minimized = !c, b && "object" == typeof b || (b = this.$sidebar.find(".sidebar-expand"), 
                0 == b.length && (b = a('.sidebar-expand[data-target="#' + (this.$sidebar.attr("id") || "") + '"]')), 
                b = 0 != b.length ? b[0] :null), b) {
        ...
        this.show = function(b, c, d) {
            ...
            var h = function(b, c) {
                b && b.stopPropagation(), f.css({
                    ...
                    "transition-property":"",
                    "transition-duration":""
                }).removeClass("nav-show").addClass("nav-hide"), c !== !1 && f.trigger(a.Event("hidden.ace.submenu")), 
                d && (j = !1);
            };
            ...
            if (1 == this.mobile_style || 2 == this.mobile_style) {
                ...
                b = 0 != b.length ? b[0] :null), c ? (this.$sidebar.addClass("display"), b && a(b).addClass("display")) :(this.$sidebar.removeClass("display"), 
                b && a(b).removeClass("display")), c ? f.$sidebar.trigger(a.Event("mobileShow.ace.sidebar")) :f.$sidebar.trigger(a.Event("mobileHide.ace.sidebar"));
            }
        ...
        this.$sidebar.on(ace.click_event + ".ace.submenu", ".nav-list", function(b) {
            ...
            if (d && 0 != d.length) {
                ...
                if (d.hasClass("dropdown-toggle")) {
                	...
                	if(target.is("i.arrow")||d.hasClass("no-page")){
	                    ...
	                    k ? (f.show(g, f.settings.duration), 0 != i && (i += g.scrollHeight)) :(f.hide(g, f.settings.duration),
	                    i -= g.scrollHeight), 
    ...
    function c(b, c) {
        ...
        if (f = l.find(".nav-list"), g = f.get(0)) {
            ...
            var w, x, y = function() {
                ...
                if (!v && j.sidebar_fixed && (f = l.find(".nav-list"), h = l.find(".sidebar-toggle").eq(0), 
                i = l.find(".sidebar-shortcuts").eq(0), g = f.get(0))) {
                    f.wrap('<div class="nav-wrap-up pos-rel" />'), f.after("<div><div></div></div>"), 
                    f.wrap('<div class="nav-wrap" />'), j.settings.include_toggle || h.css({
                        "z-index":1
                        ...
                        touchDrag:!1
                    }).closest(".ace-scroll").addClass("nav-scroll"), u = p.data("ace_scroll"), q = p.find(".scroll-content").eq(0), 
                    r = q.find(" > div").eq(0), t = a(u.get_track()), s = t.find(".scroll-bar").eq(0), 
                    j.settings.include_shortcuts && 0 != i.length && (f.parent().prepend(i).wrapInner("<div />"), 
                    f = f.parent()), j.settings.include_toggle && 0 != h.length && (f.append(h), f.closest(".nav-wrap").addClass("nav-wrap-t")), 
                    f.css({
                        position:"relative"
                    }), 1 == j.settings.scroll_outside && p.addClass("scrollout"), g = f.get(0), g.style.top = 0, 
                    ...
                    if (f.on("ace_drag.nav", function(b) {
                        ...
                        if ("up" == b.direction || "down" == b.direction) {
                            u.move_bar(!0);
                            var d = b.dy;
                            d = parseInt(Math.min(w, d)), Math.abs(d) > 2 && (d = 2 * d), 0 != d && (c.scrollTop = c.scrollTop + d, 
                    ...
                    if (v = !0, 1 == b && (j.reset(), n && j.scroll_to_active(), n = !1), "number" == typeof j.settings.smooth_scroll && j.settings.smooth_scroll > 0 && (f.css({
                        ...
                        a(window).on("scroll.ace_scroll", function() {
                            j.is_scrolling && u.is_active() && (m = ace.helper.winHeight(), m != o && (o = m, 
                            j.reset()));
                        });
                    }
                }
    ...
    a(document).on("settings.ace.sidebar_scroll", function(b, c, d) {
        a(".sidebar[data-sidebar-scroll=true]").each(function() {
            ...
            d._reset(); else if ("sidebar_fixed" === c || "navbar_fixed" === c) {
    ...
    function c(b, c) {
        function h(b) {
            ...
            this.show = function() {
                ...
                f = !1, d.removeClass("hover-show hover-shown hover-flip"), null != e && clearTimeout(e), 
                e = null;
        ...
        function k(c) {
            ...
            B && this.parentNode == p && (v = 0, m.top += d.height(), C = !0), !C && (v = t - (y + h)) >= 0 && (v = z > v ? v :z, 
            0 == v && (v = 20), z - v > 10 && (v += parseInt(Math.min(25, z - v))), m.top + (n - o) > t - v && (v -= m.top + (n - o) - (t - v)), 
            v > 0 && (c.style.top = -v + "px", g && (g.style.marginTop = -v + "px"))), 0 > v && (v = 0);
            var D = v > 0 && v > n - 20;
                ...
                if (J > 0 && n > J && (I += parseInt(Math.max(n, n - J))), I -= 5, !(90 > I)) {
                    ...
                    if (x = I, !e && K) {
                        ...
                        if (L) {
                            ...
                            M += s ? 2 :f.outerWidth() - K.track_size(), L.style.left = parseInt(M) + "px", 
        ...
        this.update_vars = function() {
            ...
            0 != l.dirty && (l.dirty = !1, o.find(".submenu").each(function() {
                ...
                f(this, "absolute") ? b.addClass("can-scroll") :b.removeClass("can-scroll"), c.removeClass("pull_up").find(".menu-text:first").css("margin-top", "");
        ...
        o.on(z, ".nav-list li, .sidebar-shortcuts", function(b) {
            if (q = o.ace_sidebar("vars"), !q.collapsible) {
                ...
                var j = h, m = !1;
                if (j || this.parentNode != p || (j = c.find("> a > .menu-text").get(0)), !j && e && (j = c.find(".sidebar-shortcuts-large").get(0)), 
                !(j && (m = f(j, "absolute")) || g)) return void (h && a(h).removeClass("can-scroll"));
                var n = t ? i(this) :null;
                if (h) if (m) {
                    l.dirty = !0;
                    var s = ace.helper.scrollTop();
                    if (t && !n.is_visible() || !d && s != y || r) if (a(h).addClass("can-scroll"), 
                    r || d) {
                        var u = this;
                        setTimeout(function() {
                            k.call(u, h);
    ...
    var d = function(b, d) {
        ...
        this.reload = function() {
            ...
            if (b || (b = e.find("> .widget-header a[data-action=collapse]").eq(0), 0 == b.length && (b = null)), 
            b) {
            ...
            "show" == h ? (g && g.removeClass(k).addClass(l), f.hide(), e.removeClass("collapsed"), 
            ...
            a === !0 || g && !f ? (b.removeClass(d).addClass(e), this.$box.addClass("fullscreen"), 
            c(this.$box, !0)) :(a === !1 || g && f) && (b.addClass(d).removeClass(e), this.$box.removeClass("fullscreen"), 
            c(this.$box, !1)), this.$box.trigger("fullscreened.ace.widget");
        };
    };
    ...
    a("#ace-settings-btn").on(ace.click_event, function(b) {
        ...
        if (!a("#sidebar").hasClass("h-sidebar")) {
            ...
            a(".sidebar[data-sidebar-hover=true]").ace_sidebar_hover("reset"), a(".sidebar[data-sidebar-scroll=true]").ace_sidebar_scroll("reset"), 
            ace.vars.old_ie && ace.helper.redraw(a("#sidebar")[0]);
        }
    });
    a(document).on("settings.ace", function(b, c, d, e, f) {
        ...
        navbar_fixed:function(b, c, d, e) {
            ...
            c ? a(b).addClass("navbar-fixed-top") :a(b).removeClass("navbar-fixed-top"), d && ace.settings.saveState(b, "class", "navbar-fixed-top", c), 
        ...
        sidebar_fixed:function(b, c, d, e) {
            ...
            c ? (a(b).addClass("sidebar-fixed"), g.addClass("fixed")) :(a(b).removeClass("sidebar-fixed"), 
            g.removeClass("fixed")), d && (ace.settings.saveState(b, "class", "sidebar-fixed", c), 
            0 != g.length && ace.settings.saveState(g[0], "class", "fixed", c)), a(document).trigger("settings.ace", [ "sidebar_fixed", c, b, d ]);
        },
        breadcrumbs_fixed:function(b, c, d, e) {
            ...
            c ? a(b).addClass("breadcrumbs-fixed") :a(b).removeClass("breadcrumbs-fixed"), d && ace.settings.saveState(b, "class", "breadcrumbs-fixed", c), 
        ...
        main_container_fixed:function(b, c, d) {
            ...
            a(f).removeClass("container")), d && (ace.settings.saveState(b, "class", "container", c), 
            0 != f.length && ace.settings.saveState(f[0], "class", "container", c)), navigator.userAgent.match(/webkit/i) && (a("#sidebar").toggleClass("menu-min"), 
            setTimeout(function() {
    ...
    var c = function() {
        function b(b) {
            ...
            c("align-left", "align-right"), c("no-padding-left", "no-padding-right"), c("arrowed", "arrowed-right"), 
            c("arrowed-in", "arrowed-in-right"), c("tabs-left", "tabs-right"), c("messagebar-item-left", "messagebar-item-right"), 
            a(".modal.aside-vc").ace_aside("flip").ace_aside("insideContainer"), e.find(".fa").each(function() {
    ...
    a("#skin-colorpicker").on("change", function() {
        function b(b) {
            ...
            a(".ace-nav > li.grey").removeClass("dark"), a(".ace-nav > li").removeClass("no-border margin-1"), 
            ...
            } else if ("skin-2" == b) a(".ace-nav > li").addClass("no-border margin-1"), a(".ace-nav > li:not(:last-child)").addClass("light-pink").find("> a > " + ace.vars[".icon"]).addClass("pink").end().eq(0).find(".badge").addClass("badge-warning"), 
            a(".sidebar-shortcuts .btn").attr("class", "btn btn-white btn-pink").find(ace.vars[".icon"]).addClass("white"), 
            a(".sidebar[data-sidebar-scroll=true]").ace_sidebar_scroll("updateStyle", "scroll-white no-track"), 
            a(".sidebar[data-sidebar-hover=true]").ace_sidebar_hover("updateStyle", "no-track scroll-thin scroll-white"); else if ("skin-3" == b) {
